...
public class StaffLoan{
    @Id
    @GeneratedValue(generator = "staff_loan_id_generator")
    @GenericGenerator(
            name = "staff_loan_id_generator",
            strategy = "com.machidior.Loan_Management_Service.generator.StaffLoanIdGenerator"
    )
    private String id;
